      ...
      <div className="blog-container">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {categories.map(category => (
                <li key={category.id}>
                  <Link href={category.link} className="text-gray-400 hover:text-blog-yellow transition-colors">
                    {category.navTitle}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/about" className="text-gray-400 hover:text-blog-yellow transition-colors">
                  Обо мне
                </Link>
              </li>
              <li>
                <Link href="/contact" className="text-gray-400 hover:text-blog-yellow transition-colors">
                  Контакты
                </Link>
              </li>
              <li>
                <Link href="/privacy" className="text-gray-400 hover:text-blog-yellow transition-colors">
                  Конфиденциальность
                </Link>
              </li>
            </ul>
